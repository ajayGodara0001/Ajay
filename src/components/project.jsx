...
function Project({pName, pInfo, tech , imgUrl, theme}) {
  return (
    ...
    <div>
      ...
      <div>
        <div className='text-white text-lg bg-blue-800 m-4 text-center py-1 rounded-xl hover:bg-blue-950 hover:cursor-pointer'>Live Link</div>
        <div className='text-white text-lg bg-blue-800 m-4 text-center py-1 rounded-xl hover:bg-blue-950 hover:cursor-pointer'>Github Link</div>
      </div>
    </div>
